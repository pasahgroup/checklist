...
<div class="container-fluid">
    <div class="row">
        ...
        <table cellspacing='0' cellpadding='5' style="border-width: 0 !important;padding:0px 0px 0px 60px;">
            <tr>
                <td style="padding: 10px;"><img src="data:image/png;base64,{{ base64_encode(file_get_contents(storage_path('app/public/logo/logo.jpg'))) }}" width="60px" height="60px"></td>
                <td>
...
<div class="content" >
      <div class="row">
        <table style='width:100%;font-size:14px;text-align:center;border:1px solid #000000;' id='items'  cellpadding='0' cellspacing='0'>
            ...
            <thead>
                <tr>
                    <td style='width:7%;font-weight:bold;'>Sno.</td>
