						...
						<div class="container-fluid">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb bg-white mb-0 px-0 py-2">
									<li class="breadcrumb-item active" aria-current="page">Returned Stocks</li>
								</ol>
							</nav>
						</div>
					</div>
											...
											<div class="card card-custom gutter-b bg-transparent shadow-none border-0" >
												<div class="card-header align-items-center  border-bottom-dark px-0">
													<div class="card-title mb-0">
														<h3 class="card-label mb-0 font-weight-bold text-body">Returned Stocks
														</h3>
													</div>
...
<button type="button" class="btn btn-sm btn-success btn-xs" data-toggle="modal" data-target="#issue{{ $stock->pending_id }}">
  ...
  <input type="hidden" name="pending_id" class="form-control" value="{{ $stock->pending_id }}">
   ...
   <input type="hidden" name="pending_qty" class="form-control" value="{{ $stock->Qty_issued }}">
                            ...
                            <input type="text" name="from" class="form-control" value="{{ $from_wherehouse->warehouse }}" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="qty" class="form-control" value="{{ $stock->Qty_issued }}" max="{{ $stock->Qty_issued }}" min="1">
                        </div>
                    </div>
                </div>
