...
use App\Models\ins;
use App\Http\Requests\StoreinsRequest;
...
public $index=[];
    ...
    public function index()
    {
      ...
      $metanameCollects=collect($metanames);
            ...
            return view('ins',compact('departGetName','metadatas','datatypes','metanames','metanameCollects','metaAll','pp','metas','qns','sections','userActitivities','userMetanames','acts','col','checkQnsProp','checkQns','assetPerc','answerPerc','answerCount','totalqns','qnsAppliedPerc','property_id'));
            // ->layout('layouts.app');
     ...
     *
     * @param  \App\Http\Requests\StoreinsRequest  $request
     * @return \Illuminate\Http\Response
     */
    public function store(StoreinsRequest $request)
    {
      $rad=$this->rad;
     ...
     *
     * @param  \App\Http\Requests\UpdateinsRequest  $request
     * @param  \App\Models\ins  $ins
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateinsRequest $request, ins $ins)
    {
        //
    }
