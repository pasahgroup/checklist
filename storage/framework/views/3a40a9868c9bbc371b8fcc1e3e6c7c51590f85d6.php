...
<?php $component->withAttributes([]); ?>
    <form   id="basicform1"  name="basicform1" method="POST"  action="<?php echo e(route('company-profile-create.store')); ?>" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
    ...
    <input type="hidden"  id="profile_web" name="profile_web" class="form-control" value="profile_web">
      ...
      <div class="card-body p-5 step" style="display: none">
           ...
           <div class="form-group row pt-2">
             ...
             <div class="col-8">
              <input class="form-control" type="email" id="email" name="email" placeholder="company email" required>
                 <div class="invalid-feedback">This field is required</div>
             </div>
           </div>
           ...
           <div class="form-group row pt-2">
             ...
             <div class="col-8">
               <input type="password" placeholder="Your Password" id="password" name="password" class="form-control" autocomplete="off" required>
                 <div class="invalid-feedback">This field is required</div>
             </div>
           </div>
      ...
      <div class="card-footer">
        <button class="action back btn btn-sm btn-outline-warning" style="display: none" onclick="myFunc(e)" id="BUTTON_ID" name="BUTTON_ID">Back</button>
        <button class="action next btn btn-sm btn-outline-secondary float-end"="" onclick="myFunc(e)" id="BUTTON_ID" name="BUTTON_ID">Next</button>
