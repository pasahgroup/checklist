                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <select name="department" id="" class="form-control">
                                        ...
                                        <option value="<?php echo e($user->department_id); ?>"><?php echo e($user->department_name); ?></option>
                ...
                <button type="submit" class="btn btn-success" >Update</button>
                                                                            ...
                                                                            <div class="card-toolbar text-right">
                                                                               ...
                                                                               <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdowneditButton2"  style="position: absolute; transform: translate3d(1001px, 111px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                                  ...
                                                                                  <a href="<?php echo e(route('update-user',$user->id)); ?>" class="btn-success dropdown-item click-recovery" id="click-edit1" onclick="return confirm(id='Are you sure you want to Recovery this  <?php echo e($user->name); ?>')">Recovery</a>


                                                                               <form action="<?php echo e(route('user-register.destroy',$user->id)); ?>" method="POST">
                                                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\checkmaster2\resources\views/admin/settings/recovery/recoveryUser.blade.php ENDPATH**/ ?>