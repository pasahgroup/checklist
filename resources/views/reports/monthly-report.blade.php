...
<div class="content d-flex flex-column flex-column-fluid" id="tc_content">
                                 ...
                                 <div class="col-md-3">
                                   <!-- <x-jet-button class="ml-4">
                                     ...
                                     <div class="form-group" style="padding:22px;">
                                       ...
                                       <x-jet-button class="btn-primary" name="print" value="print">
                                           {{ __('Print') }}
                                       </x-jet-button>
                                       </div>
                                 </div>
 ...
 @if($monthlyData->answer_label ==='Maintenance-low') style="background-color:#efca1f;"@endif @if($monthlyData->answer_label ==='Maintenance-medium') style="background-color:#db6515;"@endif @if($monthlyData->answer_label ==='Maintenance-high') style="background-color:#db5a5a;"@endif
                                                 @if($monthlyData->answer_classification ==='Good') style="background-color:green;"@endif>{{ $monthlyData->answer}}@if($monthlyData->answer_label !='no_value') ({{$monthlyData->answer_label}}) @endif</td>
