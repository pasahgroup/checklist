                ...
                <tr>
                    <td style='width:40%'>
                        <table style='width:90%;padding-right: 0px;' cellpadding='0' cellspacing='0'>
                            <tr>
                                <td style='width:100%;padding:1px;padding-left:10px;' colspan='2'>DEPARTMENT: <strong>{{$depart->department_name}}</strong></td>
                            </tr>
                            <tr>
            ...
            <tbody>
               ...
               @foreach ($reportData as $indexKey => $DailyReader)            
                <tr>
                  ...
                  <td style='text-align: center;'>{{$DailyReader->name}}</td>
                  <td style='text-align: center;'>{{$DailyReader->datex}}</td>
                </tr>
