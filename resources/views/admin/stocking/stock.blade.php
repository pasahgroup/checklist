						...
						<div class="container-fluid">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb bg-white mb-0 px-0 py-2">
									<li class="breadcrumb-item active" aria-current="page">Issue Stocks</li>
								</ol>
							</nav>
						</div>
					</div>
											...
											<div class="card card-custom gutter-b bg-transparent shadow-none border-0" >
												<div class="card-header align-items-center  border-bottom-dark px-0">
													<div class="card-title mb-0">
														<h3 class="card-label mb-0 font-weight-bold text-body">Issue Stocks
														</h3>
													</div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Issue Stock  {{ $stock->item }}</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <h5>From {{ $stock->warehouse }}</h5>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="from" class="form-control" value="{{ $stock->warehouse }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="to" id="" class="form-control" required>
                                ...
                                @if($warehouse->warehouse !== $stock->warehouse)
