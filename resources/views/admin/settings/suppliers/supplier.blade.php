...
@section('content')
				...
				<div class="content d-flex flex-column flex-column-fluid" id="tc_content">
					...
					<div class="d-flex flex-column-fluid">
						...
						<div class="container-fluid">
															...
															<table id="orderTable" class="display" style="width:100%">
																...
																<tbody class="kt-table-tbody text-dark">
																	...
																	<tr class="kt-table-row kt-table-row-level-0">
																		...
																		<td><a href="{{ route('suppliers.show',$supplier->id) }}">
                                                                            <span class="@if($supplier->to<0)text-danger @endif @if($supplier->to>0)text-success @endif">{{ number_format($supplier->to) }}</span></td>
                                                                        </a>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <!-- Modal -->
                            <div class="modal fade" id="pay{{ $supplier->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h5 class="modal-title" id="exampleModalLabel">Pay in Advance {{ $supplier->supplier_name }} </h5>
                            ...
                            <button type="button" class="btn btn-sm btn-warning btn-xs" data-toggle="modal" data-target="#pay{{ $supplier->id   }}">
                                                                            Advance
                                                                          </button>
                                                                        </td>
  ...
  <div class="modal fade" id="edit{{ $supplier->id }}" tabindex="-1" role="dialog " aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Edit {{ $supplier->supplier_name }}</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
            ...
            <form action="{{ route('suppliers.update',$supplier->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <label class="text-dark" >Contact Person Name <span class="text-danger"> * </span></label>
                            <input type="text" name="contact_person" class="form-control" required value="{{ $supplier->contact_person}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="position" class="form-control" required value="{{ $supplier->position}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="tin" class="form-control" required value="{{ $supplier->tin}}">
                            <small  class="form-text text-muted">please enter TIN number</small>
                        </div>
                        <div class="form-group">
                            <label class="text-dark" >VRN </label>
                            <input type="number" name="vrn" class="form-control" value="{{ $supplier->vrn}}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control"  rows="3" placeholder="Provide supplier address" name="address">{{ $supplier->address}}</textarea>
                          </div>
                    </div>
                </div>
  ...
  {{-- end of modal --}}
                                    ...
                                    <div class="card-toolbar text-right">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdowneditButton2"  style="position: absolute; transform: translate3d(1001px, 111px, 0px); top: 0px; left: 0px; will-change: transform;">
                                            ...
                                            <a href="javascript:void(0)" class="dropdown-item click-edit" data-toggle="modal" data-target="#edit{{ $supplier->id }}">Edit</a>
		...
		<form id="myform" action="{{ route('suppliers.store') }}" method="POST">
			...
			<div class="row">
				<div class="col-12">
                    ...
                    <div class="form-group">
						<label class="text-dark" >TIN <span class="text-danger"> * </span></label>
						<input type="number" name="tin" class="form-control" required>
                        <small  class="form-text text-muted">please enter phone number</small>
					</div>
                    <div class="form-group">
						<label class="text-dark" >VRN </label>
						<input type="number" name="vrn" class="form-control" >
                        <small  class="form-text text-muted">please enter phone number</small>
					</div>
                    <div class="form-group">
						<label class="text-dark" >Email Address <span class="text-danger"> * </span></label>
					...
					<div class="form-group">
						<label class="text-dark" >Address </label>
						<textarea class="form-control"  rows="3" placeholder="Provide supplier address" name="address"></textarea>
					  </div>
				</div>
			</div>
