...
@section('content')
				...
				<div class="content d-flex flex-column flex-column-fluid" id="tc_content">
											...
											<div class="card card-custom gutter-b bg-transparent shadow-none border-0" >
												<div class="card-header align-items-center  border-bottom-dark px-0">
													<div class="card-title mb-0">
														<h3 class="card-label mb-0 font-weight-bold text-body">Shop list
														</h3>
													</div>
												    <div class="icons d-flex">

                                                        @if(count($warehouses) < $limitation->limit_shop)
                    ...
                    <div class="form-group">
                        ...
                        <select class="arabic-select w-100 mb-3 h-30px" name="location" id="" required>
                            <option selected>{{ $warehouse->location }}</option>
                        ...
                        <small  class="form-text text-muted">please enter warehouse location</small>
                                                            ...
                                                            <div class="card-toolbar text-right">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdowneditButton2"  style="position: absolute; transform: translate3d(1001px, 111px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                    <a href="javascript:void(0)" class="dropdown-item click-edit" data-toggle="modal" data-target="#issue{{ $warehouse->id }}">Edit</a>
                                                                    <form action="{{ route('warehouse.destroy',$warehouse->id) }}" method="POST">
                                                                        @csrf
                                                                        <input type="hidden" name="_method" value="delete">
                                                                        <input type="submit" class="dropdown-item" value="Delete" onclick="return confirm(id='Are you sure you want to delete this warehouse?')">
                                                                    </form>
                                                                </div>
                                                                </div>
                                                        </td>
