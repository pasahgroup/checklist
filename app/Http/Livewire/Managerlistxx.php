...
//  return redirect()->route('managers-inspection/{id}')->with('success','Submitted Successfully');
//   return route('/managers-inspection/{id}')->with('success', 'Submitted Successfully!');
